...
export const CourseDetails = [
  {
    ...
    course: "Game Design",
    description:
      "Learn the fundamentals of game design and create your own interactive experiences.",
  ...
  },
  {
    ...
    WULImage: "/course/Video-files.webp",
    whatULearn: [
  ...
  },
  {
    ...
    WULImage: "/course/animationpgs.webp",
    whatULearn: [
      "Storyboarding",
      "Frame Animation",
      "Study Motion",
  ...
  },
  {
    ...
    WULImage: "/course/GraphicsPng.webp",
    whatULearn: [
      "Typography",
  ...
  },
  {
    ...
    HeaderImage: "/course/3d-architechure-bg.webp",
    HeighletsImage: "/course/AnimationOverviewPGA.webp",
    WULImage: "/course/graphicWUL.webp",
    whatULearn: [
      "Graphics Designer",
      "Character Designer",
      "Background Artist",
  ...
  },
  {
    ...
    HeaderImage: "/course/bgofpda.webp",
    HeighletsImage: "/course/pdaoverview.webp",
    WULImage: "/course/GameWUL.webp",
    whatULearn: [
      "Game Designer",
      "Level Designer",
      "Game UI Designer",
